...
const SmallFlame = () => {
  return (
    <div className="small-flame-wrapper">
      <svg
        version="1.1"
        id="Layer_1"
	...
	c6.806,41.899,16.831,45.301,6.088,53.985"
        />
        <path
          className="small-flame-main one"
          fill="#F6891F"
	...
	c20.585,52.899-19.848,61.045-19.643,61.582c0.206,0.537-19.401-0.269-14.835-18.532S57.576,137.656,61.693,122.257z"
        />
        <path
          className="small-flame-main two"
          fill="#FFD04A"
	...
	C84.858,184.21,125.705,150.905,81.657,79.192z"
        />
        <path
          className="small-flame-main three"
          fill="#FDBA16"
	...
	C95.354,106.319,99.92,114.108,99.92,101.754z"
        />
        <path
          className="small-flame-main four"
          fill="#F36E21"
